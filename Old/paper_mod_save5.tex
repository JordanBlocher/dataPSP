...
\end{equation}
% EXACTING STRATEGY, SAVE JUST IN CASE
\iffalse
...
\iffalse %SAVING IN CASE ITERATIVELY ASSIGNING DATA DOES NOT WORK
$$
    \ell_i =\argmax_{\mcI_i' \subset \mcI_i, \vert\mcI_i'\vert =
n}\sum_{j\in\mcI_i'} d^j.
$$
...
% SELLER INCENTIVE COMPATIBILITY
{
\proposition{(Seller incentive compatibility)}\label{sellerincentivecompatibility}
